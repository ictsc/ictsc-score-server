...
RSpec.describe ScoresController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new score" do
        ...
        expect(response.location).to eq(score_url(Score.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new score" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the score" do
        score = Score.create! valid_attributes
