...
Team.create!(role: 'staff', name: Team.special_team_name_staff, beginner: false, organization: '運営', color: '', number: 999, secret_text: '', password: ENV.fetch('API_STAFF_PASSWORD'))
