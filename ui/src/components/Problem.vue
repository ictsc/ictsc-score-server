  ...
  >
    ...
    <div v-if="!asyncLoading">
      <header>
        ...
        <div class="meta">
          公開　{{ problem.created_at }}　|　更新　{{ problem.updated_at }}
        </div>
        <div class="point">
          <template v-if="edit && (isWriter || isAdmin)">
            ...
            <div class="form-group row">
              ...
              <div class="col-10">
                <select
                  v-model="problem.problem_must_solve_before_id"
                  class="form-control"
                >
                  <option
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <select
                  v-model="problem.problem_group_ids"
                  class="form-control"
                  multiple
                >
                  <option
            ...
            <div class="form-group row">
              <label class="col-2 col-form-label">表示順序(昇順)</label>
              <div class="col-10">
                <input
            ...
            <div class="form-group row">
              ...
              <div class="col-10">
                <select
                  v-model="problem.creator_id"
                  class="form-control"
                >
                  <option
                    v-for="creator in creatorSelect"
                    v-if="creator.role_id===3"
                    :value="creator.id"
                  >
                    {{ creator.name }}
                  </option>
            ...
            <div class="form-group row">
              ...
              <div class="col-10">
                <input
                  v-model="problem.reference_point"
                  class="form-control"
                  type="number"
                >
              </div>
      ...
      <aside>
        ...
        <div
          ...
          class="new-comment"
        >
          <simple-markdown-editor v-model="newComment" />
          <div class="text-right">
            <button
              v-on:click="newCommentSubmit()"
              class="btn btn-secondary"
            >
              <i class="fa fa-plus" /> 補足追加
            </button>
          </div>
        </div>
      </aside>
